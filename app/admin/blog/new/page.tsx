      ...
      <div className="max-w-5xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <p className="text-xs text-gray-500 mt-1">URL-friendly slug (auto-generated from title)</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            />
            <p className="text-xs text-gray-500 mt-1">
              Markdown formatting supported. {formData.content.length} characters
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 space-y-4">
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                />
                <span className="text-sm text-gray-700">
                  Keep this post active (uncheck to hide)
                </span>
              </label>
            </div>
            ...
            <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
              <p className="text-sm text-blue-800">
                💡 <strong>Tip:</strong> Save as Draft first to review, then publish when ready.
              </p>
            </div>
          </div>
